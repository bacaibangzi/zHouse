 ...
 */
@Service
public class DistributorService extends BaseService<RoleInfo> {
	...
	public RoleInfo getServerById(ConditionVO vo) throws Exception {
		return roleInfoMapper
				.getById(Long.parseLong(vo.getEntityId()));
	}
	...
	public void saveOrUpdateServer(RoleInfo entity) throws Exception {
		if (entity.getRiId() == null) {
			// 系统添加角色默认为1
			entity.setRiLevel(UserTypeEnum.distributor.id());
	...
	public List<RoleInfo> queryServerByCondition(ConditionVO vo)
			throws Exception {
		Map<String, Object> conditionMap = new HashMap<String, Object>();
		conditionMap.put("riLevel", UserTypeEnum.distributor.id());
