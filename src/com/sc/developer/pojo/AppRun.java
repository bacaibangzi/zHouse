 ...
 * 类功能详细描述
 */
public class AppRun  extends CubeBaseEntity implements java.io.Serializable,Cloneable
{
	private static final long serialVersionUID = 5454155825314635342L;
	
	///alias
	public static final String TABLE_ALIAS = "AppRun";
    ...
    /**
     * @brief   功能: 检测两个AppRun对象是否相同
     * @param   
     * @return  
     */
	public boolean equals(Object obj) {
		if(obj instanceof AppRun == false) return false;
		if(this == obj) return true;
		AppRun other = (AppRun)obj;
