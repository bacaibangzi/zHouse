...
<!-- jquery validate -->
<script type="text/javascript" src="<%=webfilesPath%>/common/js/validate/jquery.validate.js"></script>
<script type="text/javascript" src="<%=webfilesPath%>/common/js/validate/jquery.meta.js"></script>
