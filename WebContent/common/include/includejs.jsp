...
<!-- datable plugin -->	
<script type="text/javascript" src="<%=webfilesPath %>/common/js/datatable/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="<%=webfilesPath %>/common/js/datatable/datatable.lnpagination.js"></script>
<script type="text/javascript" src="<%=webfilesPath %>/common/js/datatable/jquery.datatable.columresize.js"></script>
