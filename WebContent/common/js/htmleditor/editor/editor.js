...
EDiaryEditor = {
    initialize: function (basepath,sEditorId, sParentID) {
        base = basepath;
        editorId = sEditorId;
        this.initView(sEditorId,sParentID);
        this.initControl();
    },
    ...
    initView: function (sEditorId,sParentID) {
        var _this = this;
        var _toolbarStr = "\
            <div id='EDiaryEditor'style='width: 621px;'>\
                <div id='EDiaryEditorToolBar' style='position: relative; width: 621px; height: 69px; background-image: url("+base+"images/editor/toolbar_bg.gif);'>\
                ...
                <div style='width: 621px; height: 25px; background-image: url("+base+"images/editor/title_bg.gif);'>\
                </div>\
                <div style='height: 300px; background-image: url("+base+"images/editor/guage.gif); padding-left: 39px; width: 582px!important ;' id='EDiaryEditorContent'>\
                    <iframe id='editor_body_area' name='editor_body_area' style='width: 550px; height: 300px; border-width: 0px; overflow-x: atuo; display: block;' frameborder='0'></iframe>\
                    <input type='hidden' name='char_count' value='-1' id='EDiaryEditorStrLen'>\
                </div>\
                <div style='width: 621px; height: 59px; background-image: url("+base+"images/editor/editor_foot.gif)'>\
        ...
        ";
        this.addHTML($get(sParentID), _toolbarStr);
        $get("EDiaryEditorContent").appendChild($get(sEditorId));
        $get(sEditorId).style.width = "550px";
        $get(sEditorId).style.height = "300px";
        $get(sEditorId).style.borderWidth = "0px";
       // $get(sEditorId).style.paddingTop = "8px";
        $get(sEditorId).style.overflow = "auto";
        $get(sEditorId).style.margin = "0px";
        $get(sEditorId).style.display = "none";
        ...
        for(var key in _toolBarInfo) {
        	if(undefined != _toolBarInfo[key]["n"])
    		{
    			//alert(_toolBarInfo[key]["n"])
        		_toolbarStr2 += "<img src='"+base+"images/editor/blank.gif' title='" + _toolBarInfo[key]["a"] + "' alt='" + _toolBarInfo[key]["a"] + "' id='EDiaryEditor" + _toolBarInfo[key]["n"] + "' style='position: absolute; left: " + _toolBarInfo[key]["l"] + "px; top: " + _toolBarInfo[key]["t"] + "px; width: " + _toolBarInfo[key]["w"] + "px; height: " + _toolBarInfo[key]["h"] + "px;' func='" + _toolBarInfo[key]["n"] + "' action='" + _toolBarInfo[key]["c"] + "'>";
    		}
        }
        this.addHTML($get("EDiaryEditorToolBar"), _toolbarStr2);
                ...
                if(key == "Family") {
                    ...
                    if(key2 == 0) {// head
                        _toolbarStr3 += "\
                            ...
                            <div style='cursor: default; position: absolute; width: 163px; top: 32px; left: 78px; display: none;' id='EDiaryEditorFontFamilyItem'>\
                                <div style='text-align: center; height: 20px; background-image: url("+base+"images/editor/menu_title.gif); padding-top: 6px; padding-left: 6px;'><b>字体</b></div>\
                                    <div style=' height: 296px!important ;height: 290px; background-image: url("+base+"images/editor/menu_bg.gif);' id='EDiaryEditorFontFamilyBox'>\
                        ";
                    }
                    ...
                    if(key2 + 1 == _toolMenuInfo[key].length) {// foot
                        _toolbarStr3 += "\
                                ...
                                <div style='height: 10px; background-image: url("+base+"images/editor/menu_foot.gif); font-size: 1px;'></div>\
                            </div>\
                        ";
                    }
                }
                    ...
                    if(key2 == 0) {// head
                        _toolbarStr3 += "\
                            ...
                            <div style='cursor: default; position: absolute; width: 163px; top: 32px; left: 175px; display: none;' id='EDiaryEditorFontSizeItem'>\
                                <div style='text-align: center; height: 20px; background-image: url("+base+"images/editor/menu_title.gif); padding-top: 6px; padding-left: 6px;'><b>字号</b></div>\
                                    <div style='height: 388px!important ;height: 306px; background-image: url("+base+"images/editor/menu_bg.gif);' id='EDiaryEditorFontSizeBox'>\
                        ";
                    }
                    if(key2 < _toolMenuInfo[key].length) {// body
                    ...
                    if(key2 == 0) {// head
                        _toolbarStr3 += "\
                            ...
                            <div style='cursor: default; position: absolute; width: 163px; top: 32px; left: 243px; display: none;' id='EDiaryEditorFontStyleItem'>\
                                <div style='text-align: center; height: 20px; background-image: url("+base+"images/editor/menu_title.gif); padding-top: 6px; padding-left: 6px;'><b>段落</b></div>\
                                    <div style='height: 231px!important ;height: 187px; background-image: url("+base+"images/editor/menu_bg.gif);' id='EDiaryEditorFontStyleBox'>\
                        ";
                    }
                    if(key2 < _toolMenuInfo[key].length) {// body
        ...
        this.addHTML($get("EDiaryEditorToolBar"), _toolbarStr3);


        var _toolbarStr5 = "\
            <div style='position: absolute; background-image: url("+base+"images/editor/blank.gif); left: 0px; top: 0px; width: " + $get("EDiaryEditor").offsetWidth + "px; height: " + $get("EDiaryEditor").offsetHeight + "px; display: none;' id='EDiaryEditorDialog'>\
                <div style='position: absolute; background-image: url("+base+"images/editor/dilog_bg.gif); left: 160px; top: 140px; width: 310px; height: 157px; display: none;' id='EDiaryEditorIMGDialog'>\
                <iframe src="+base+"'editor/img.html'></iframe>\
                </div>\
            </div>\
        ";
        //this.addHTML($get("EDiaryEditorToolBar"), _toolbarStr5);
        ...
        for(var i = 0; i < 6; i ++) {
            for(var j = 0; j < 6; j++) {
                _toolbarStr6 += ("<img src='"+base+"images/editor/blank.gif' onclick='EDiaryEditor.runCMD(\"forecolor\", \"" + c[k] + "\");' style='background: " + c[k] + ";border: 1px solid #999; margin: 0px; padding: 0px; margin-top: 1px; margin-left: 1px; width: 14px; height: 14px; cursor: hand; cursor: pointer;' />");
                k ++;
            }
            _toolbarStr6 += ('<br />');
        }
        _toolbarStr6 += "</div>";
        this.addHTML($get("EDiaryEditorToolBar"), _toolbarStr6);
        ...
        for(var i = 0; i < 6; i ++) {
            for(var j = 0; j < 6; j++) {
                _toolbarStr7 += ("<img src='"+base+"images/editor/blank.gif' onclick='EDiaryEditor.runCMD(\"hilitecolor\", \"" + c[k] + "\");' style='background: " + c[k] + ";border: 1px solid #999; margin: 0px; padding: 0px; margin-top: 1px; margin-left: 1px; width: 14px; height: 14px; cursor: hand; cursor: pointer;' />");
                k ++;
            }
            _toolbarStr7 += ('<br />');
        }
        _toolbarStr7 += "</div>";
        this.addHTML($get("EDiaryEditorToolBar"), _toolbarStr7);

        var _toolbarStr8 = "<div style='position: absolute; left: 312px; top: 66px; display: none;' id='EDiaryEditorfaceItem'>\
            <img border='0' src='"+base+"images/editor/face_bg.gif' usemap='#Map' align='center'  style='cursor: hand; cursor: pointer;'/>\
            <map name='Map'>\
        ...
        ";
        this.addHTML($get("EDiaryEditorToolBar"), _toolbarStr8);

        var _toolbarStr9 = "<div style='position: absolute; left: 0px; top: 0px; width: 621px; background: url("+base+"images/editor/blank.gif); height: 69px; display: none;' id='EDiaryEditorToolBarMask'></div>";

        this.addHTML($get("EDiaryEditorToolBar"), _toolbarStr9);   

        var _toolbarStr9 = "<div style='position: absolute; left: 483px; top: 41px; display: none;' id='EDiaryEditorRsave' title='恢复上一次未成功发表内容'><img src='"+base+"images/editor/rsave.gif' csrc='/images/rsave.gif' bsrc='/images/rsave_over.gif' onmouseover='this.src=this.bsrc' onmouseout='this.src=this.csrc'></div>";
        this.addHTML($get("EDiaryEditorToolBar"), _toolbarStr9);
        
        
        var _toolbarStr4 = "\
            <div style='position: absolute; width: 198px; height: 95px; top: 66px; left: 421px; display: none; background-image: url("+base+"images/editor/justifyformat_bg.gif);' id='EDiaryEditorJustifyFormatItem'>\
        ...
        ";
        this.addHTML($get("EDiaryEditorToolBar"), _toolbarStr4);

        var _toolBarHash = this.config.node;
        for(var key in _toolBarInfo) {
            _toolBarHash[_toolBarInfo[key]["n"]] = $get("EDiaryEditor" + _toolBarInfo[key]["n"]);
        }
        this.iframe = $get("editor_body_area");
    ...
    initControl: function () {
        ...
        var FontMenuFuncHash = {
            menulist: {
                Family: {obj: $get("EDiaryEditorFontFamilyItem")},
                Size: {obj: $get("EDiaryEditorFontSizeItem")},
                Style: {obj: $get("EDiaryEditorFontStyleItem")},
                Justify: {obj: $get("EDiaryEditorJustifyFormatItem")},
                FColor: {obj: $get("EDiaryEditorforecolorItem")},
                HColor: {obj: $get("EDiaryEditorhilitecolorItem")},
                FaceBG: {obj: $get("EDiaryEditorfaceItem")}
            },
                ...
                for(var key in _tthis.menulist) {
                    ...
                    if(esrc.getAttribute("action") == key) {
                        if(key == "Justify") {
                            ...
                            if (sRangeType == undefined || sRangeType.tagName.toLowerCase() != "img"){
                                alert('请选中图片后操作！')
                            	return;
                            }
                        }
        ...
        function hiddenDialog(event, Act) {
            if(Act == "img") {
                //$get("EDiaryEditorIMGDialog").style.display = "none";
                //$get("EDiaryEditorDialog").style.display = "none";
            }
        }
        function viewDialog(el, Act) {
            ...
            if(window._isIE) {
                ...
                if(Act == "img") {
                	//alert("该浏览器不支持本功能");
                	//return false;
                    window.showModalDialog(base+"editor/img.htm", window, "dialogWidth: 400px; dialogHeight: 200px; help: no; scroll: no; status: no");
                }
                if(Act == "link") {
                    window.showModalDialog(base+"editor/link.htm", window, "dialogWidth: 400px; dialogHeight: 200px; help: no; scroll: no; status: no");
                }
                if(Act == "table") {
                    window.showModalDialog(base+"editor/table.htm", window, "dialogWidth: 400px; dialogHeight: 200px; help: no; scroll: no; status: no");
                }
            }
            else {
                if(Act == "img") {
                	//alert("该浏览器不支持本功能");
                	//return false;
                    win = window.open(base+"editor/img.htm", null, "Width=400,Height=200");
                    win.dialogArguments = window;
                }
                if(Act == "link") {
                    win = window.open(base+"editor/link.htm", null, "Width=400,Height=200");
                    win.dialogArguments = window;
                }
                if(Act == "table") {
                    win = window.open(base+"editor/table.htm", null, "Width=400,Height=200");
                    win.dialogArguments = window;
                }
            }
        ...
        function addIMG(event, Act) {
                var html = "<img src='" + $get("EDiaryEditorIMGInput").value + "'>";
        ...
        var nDiv = $get("EDiaryEditorFontFamilyBox").getElementsByTagName("div");
        for(var i = 0; i < nDiv.length; i ++) {
            setMenuFunc(nDiv[i]);
        }
        
        var nDiv = $get("EDiaryEditorFontSizeBox").getElementsByTagName("div");
        for(var i = 0; i < nDiv.length; i ++) {
            setMenuFunc(nDiv[i]);
        }
        
        var nDiv = $get("EDiaryEditorFontStyleBox").getElementsByTagName("div");
        for(var i = 0; i < nDiv.length; i ++) {
            setMenuFunc(nDiv[i]);
        }
        function formatIMG(el, Act) {
            ...
            if (sRangeType.tagName.toLowerCase() == "img"){
                if(Act == "left") {
                    sRangeType.style.margin = "0px";
                    $(sRangeType).css("float","left");
                    sRangeType.style.display = "inline";
                    sRangeType.style.textAlign = "left";
                  //  sRangeType.setAttribute("align", "left");
                }
                if(Act == "center") {
                    sRangeType.style.margin = "0px auto";
                    sRangeType.style.display = "block";
                    $(sRangeType).css("float","");
                ...
                if(Act == "right") {
                    sRangeType.style.margin = "0px";
                    $(sRangeType).css("float","right");
                    sRangeType.style.display = "inline";
                    sRangeType.style.textAlign = "right";
                  //  sRangeType.setAttribute("align", "right");
                }
                _this.iframe.contentWindow.focus();
        ...
        function swapMode(event, Act) {
            if(Act == "code") {
                $get(editorId).style.display = "";
                $get("editor_body_area").style.display = "none";
                $get(editorId).value = _this.iframe.contentWindow.document.body.innerHTML;
                $get("EDiaryEditorToolBarMask").style.display = "";
                var info = _this.config.toolbarinfo;
                for(var key in info) {
                    $get("EDiaryEditor" + info[key]["n"]).className = "EDiaryEditorDisable";
                }
                $get("EDiaryEditorFontFamilyMenu").className = "EDiaryEditorDisable";
                $get("EDiaryEditorFontSizeMenu").className = "EDiaryEditorDisable";
                $get("EDiaryEditorFontStyleMenu").className = "EDiaryEditorDisable";
                $get("ModeCheck").checked = true;
            }
            else {
                $get(editorId).style.display = "none";
                $get("editor_body_area").style.display = "";
                _this.iframe.contentWindow.document.body.innerHTML = $get(editorId).value;
                $get("EDiaryEditorToolBarMask").style.display = "none";
                var info = _this.config.toolbarinfo;
                for(var key in info) {
                    $get("EDiaryEditor" + info[key]["n"]).className = "";
                }
                $get("EDiaryEditorFontFamilyMenu").className = "";
                $get("EDiaryEditorFontSizeMenu").className = "";
                $get("EDiaryEditorFontStyleMenu").className = "";
                $get("ModeCheck").checked = false;
            }
        }
        _this.swapMode = swapMode;
        $get("ModeCheck").onclick = function (event) {
        ...
        for(var key in this.config.node) {
        	if("undefined" != key){
	            ...
	            _imgArr[key].src = base+"images/editor/" + key + ".gif";
	            _imgArr[key + "_over"] = new Image;
	            _imgArr[key + "_over"].src = base+"images/editor/" + key + "_over.gif";
        ...
        $get("EDiaryEditorface").onclick = $get("EDiaryEditorhilitecolor").onclick = $get("EDiaryEditorforecolor").onclick = $get("EDiaryEditorjustifyformat").onclick = $get("EDiaryEditorFontStyleMenu").onclick = $get("EDiaryEditorFontSizeMenu").onclick = $get("EDiaryEditorFontFamilyMenu").onclick = function (event) {
        ...
        $get("EDiaryEditorIMGLeft").onmouseup = function (event) {
            formatIMG(event, "left");
        }
        $get("EDiaryEditorIMGCenter").onmouseup = function (event) {
                formatIMG(event, "center");
        }
        $get("EDiaryEditorIMGRight").onmouseup = function (event) {
                formatIMG(event, "right");
        }       
        $get("EDiaryEditorimg").onclick = function (event) {
            viewDialog(event, "img");
        }
        $get("EDiaryEditorlink").onclick = function (event) {
            viewDialog(event, "link");
        }
        $get("EDiaryEditortable").onclick = function (event) {
        ...
        this.cacheIframe.style.display = "none";
        ...
        $get("EDiaryEditorview").onclick = function () {
            $get(editorId).value = _this.iframe.contentWindow.document.body.innerHTML;
            article_preview();
        }
    },
