...
(function () {
	...
	n(v.lang, {downloadPNG:"饼图", downloadJPEG:"JPEG格式", downloadPDF:"PDF格式", downloadSVG:"柱状图", exportButtonTitle:"切换", printButtonTitle:"Print the chart"});
	...
	v.exporting = {type:"image/png", url:"http://export.highcharts.com/", width:800, buttons:{exportButton:{symbol:"exportIcon", x:-10, symbolFill:"#A8BF77", hoverSymbolFill:"#768F3E", _id:"exportButton", _titleKey:"exportButtonTitle", 
	menuItems:[{textKey:"downloadPNG", onclick:function () {
		 currentChartStyle='pie'; drawChart();
	}},{textKey:"downloadSVG", onclick:function () {
		 currentChartStyle='clumn'; drawChart();
	}}]}}};
