...
<html>
<head>
<title>APP用户留存率分析报表</title>
</head>
<body>
	<div style="font-weight: bold; font-size: 15px; margin-top: 20px;margin-left: 15px" >APP用户留存率分析报表</div>
    <div class="contenbox">
	...
	<script type="text/javascript">
		...
		$(".Js_searchTable").live("click",function(){
			...
			var reportURL = "<%=basePath%>ReportServer?reportlet=/ReportCost.cpt&dateStr1="+dateStr1 + "&dateStr2=" + dateStr2+"&userId=${sessionScope.accountInfo.userId}" ;
