...
function challs_flash_update(){ //Flash 初始化函数
	...
	//a.url = "update.php"; 
	a.url = "<%=basePath%>fileManage/dishImageUpload.upload?orgCode=${vo.orgCode}&code1=${vo.code1}&entityId=${vo.entityId}";
	//a.url = "index.html";
	//设置服务器接收代码文件
...
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"  codebase="http://t.jsg.com/swflash.cab#version=10,0,0,0" width="877" height="577" id="update" name="upload" align="middle">
