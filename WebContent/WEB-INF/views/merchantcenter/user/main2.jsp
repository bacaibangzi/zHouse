...
<html>	
	...
	<body id="body" style="overflow:hidden">
			<div id="mask" style="height:100%;width:100%;text-align:center;" hidden=hidden><img style="margin-top:16%" src="<%=basePath%>common/images/mask.jpg"><strong>正在加载数据。。</strong></div>
