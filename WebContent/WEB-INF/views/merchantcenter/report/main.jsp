    ...
    <div class="leftmenu2">
        <ul>
         	<li id="menu1" onclick="choose()" class="leftmenu1_icon_m1">
         		<a href='#'><span class="forpng">菜品消费明细报表</span></a>
         	</li>
            <li id="menu2" onclick="choose()" class="leftmenu1_icon_m1">
            	<a href='#'><span class="forpng">菜品消费汇总报表</span></a>
            </li>    
            <li id="menu3" onclick="choose()" class="leftmenu1_icon_m1">
            	<a href='#'><span class="forpng">营业收银报表</span></a>
            </li>
            <li id="menu3" onclick="choose()" class="leftmenu1_icon_m1">
            	<a href='#'><span class="forpng">退菜情况报表</span></a>
            </li>  
            <li id="menu4" onclick="choose()" class="leftmenu1_icon_m1">
            	<a href='#'><span class="forpng">销售排行统计报表</span></a>
            </li>  
            <li id="menu5" onclick="choose()" class="leftmenu1_icon_m1">
            	<a href='#'><span class="forpng">日营业情况统计报表</span></a>
            </li>  
            <li id="menu6" onclick="choose()" class="leftmenu1_icon_m1">
            	<a href='#'><span class="forpng">日周月报表分析报表</span></a>
            </li> 
            <li id="menu7" onclick="choose()" class="leftmenu1_icon_m1">
            	<a href='#'><span class="forpng">会员充值汇总报表</span></a>
            </li> 
            <li id="menu8" onclick="choose()" class="leftmenu1_icon_m1">
            	<a href='#'><span class="forpng">会员余额积分报表</span></a>
            </li> 
            <li id="menu9" onclick="choose()" class="leftmenu1_icon_m1">
            	<a href='#'><span class="forpng">会员卡量统计报表</span></a>
            </li>
        </ul>
        <ul id="ctl00_ContentPlaceHolder1_menu1_ulMenuList"></ul>     
    </div>
</div>
<div id="ctl00_ContentPlaceHolder1_menu1_divMenuId" style="display: none">
</div>
