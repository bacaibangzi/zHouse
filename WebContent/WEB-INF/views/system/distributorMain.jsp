...
<body>
    ...
    <div class="contenbox">
    	<div class="grid_summay_opts" id="btns">
				<div class="left_opts">
						<a hideFocus="true" href="javascript:add('<%=basePath%>distributor/eidt.htm?orgCode=${sessionScope.accountInfo.orgCode}')" class="gray_radiu_btn" >
							<em class="gray_l"></em> 
							<em class="gray_r"></em> 
							新增
						</a>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			tableObj.aoColumns=[
				...
				{"mDataProp":"riId","sDefaultContent": "","bSortable":false,"sClass":"text-align-mid","sWidth":"100"},
				{"mDataProp":"riName","sDefaultContent": "","bSortable":false,"sClass":"text-align-mid","sWidth":"100"},
				{"mDataProp":"riMemo","sDefaultContent": "","bSortable":false,"sClass":"text-align-mid","sWidth":"100"}
			];
			//添加额外的参数
		...
		function update()
		{
			...
			window.location = "<%=basePath%>distributor/eidt.htm?entityId="+selectId; 
		}
		/** 查看详情 **/
		function detail()
		{
			...
			var selectId = data.idStr;
			// 明细弹出框
			var commonDialog = commonOpenDialog("readDetail",'详细',700,450, '<%=basePath%>distributor/detail.htm?entityId=' + selectId);
		...
		function highQuery()
		{
			...
			var returnVal = '<%=basePath%>distributor/list.htm?orgCode=${sessionScope.accountInfo.orgCode}';
			if(areaName_filter!=''){
		...
		function deleteAll()
		{
			...
			var actionUrl = "<%=basePath%>distributor/delete.htm?code=${vo.code}&entityIds=";
