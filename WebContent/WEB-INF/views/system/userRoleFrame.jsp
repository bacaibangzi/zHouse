...
<body class="fixed-box">
  		<div id="Js_asideMod" class="fixed-side2">
			<iframe id="Js_commTree" name="group_tree" width="100%"
				src="<%=basePath%>userrole/leftList.htm?orgCode=${sessionScope.accountInfo.orgCode}" frameborder="0"
				bordercolor="blue" scrolling="auto">
			</iframe>
		</div>
		<!-- main box -->
		<div id="Js_mainMod" class="fixed-main2">
			<iframe name="group_info" width="100%" id="group_info"
				src="<%=basePath%>userrole/rightTree.htm?orgCode=${sessionScope.accountInfo.orgCode}" frameborder="0"
				bordercolor="blue" scrolling="auto">
			</iframe>
		</div>
		<!--split bar-->
		<div id="Js_spitBarMod" class="Js_closeBar fixed-bar2"></div>
