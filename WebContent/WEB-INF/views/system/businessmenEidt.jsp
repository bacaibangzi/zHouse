...
<title>角色修改</title>
	...
	<body>
		<div  class="form-mod"><div style="color:#F00;font-size:22px;">${vo.errMsg}</div>
			<form:form commandName="form" id="form" action="../businessmen/save.htm" method="post">
				...
				<tbody>
					...
					<tr>	
						...
						<td >
							<input type="password" name="uiPassword" value="${form.uiPassword }"  class="input-text { required: true,minlength: 6,maxlength: 20}"> 
						</td>
					</tr>
					<tr>	
						<td class="hd" >
