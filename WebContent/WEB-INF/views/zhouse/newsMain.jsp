...
<body>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			var tableObj={}
			tableObj.url="<%=basePath%>news/list.htm?orgCode=${sessionScope.accountInfo.userId}";
			...
			tableObj.aoColumns=[
				...
				{"mDataProp":"title","sDefaultContent": "","bSortable":false,"sClass":"text-align-mid","sWidth":"200"},
				{"mDataProp":"userName","sDefaultContent": "","bSortable":false,"sClass":"text-align-mid","sWidth":"100"},
				{"mDataProp":"shenHe","sDefaultContent": "","bSortable":false,"sClass":"text-align-mid","sWidth":"100"},
		...
		function update()
		{
			...
			window.location = "<%=basePath%>news/eidt.htm?entityId="+selectId; 
		...
		function detail()
		{
			...
			var selectId = data.idStr;
			// 明细弹出框
			var commonDialog = commonOpenDialog("readDetail",'详细',700,450, '<%=basePath%>news/detail.htm?entityId=' + selectId);
