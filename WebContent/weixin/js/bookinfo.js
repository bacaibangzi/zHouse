...
function  submit_F(){
	...
	var oderer_elm = document.getElementById("orderer");
	var date = date_elm.value;
	var time = time_elm.value;
	var num = num_elm.value;
	var tel = tel_elm.value;
	var orderer = oderer_elm.value;
	var type = document.getElementById("eatTable").value;
	
	//var flag = $("input[name='eatTable']:checked").val();
	//if(flag!="3"){
		if(isNull(date))
		{
			alert("请选择就餐日期");
