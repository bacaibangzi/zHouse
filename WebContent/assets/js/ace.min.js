...
ace.handle_side_menu = function(a) {
    ...
    function(h) {
    	...
    	var _height = (windowheight-134)<680?680:(windowheight-134);
    	//alert(_height);
    	var _menus = a("#menus > li");
    	//alert(_menus.length);
    	_height = _height - 40*_menus.length -40 ;
    	
        a("#sidebar").find(".submenu").css("height", _height+"px");
        ...
        //alert(a("#sidebar").find(".submenu").height());
        return false
    })
};
